...
|:---:|:---:|:---:|:---:|:---:|
|1|[two-sum](https://leetcode.com/problems/two-sum)|[Python](https://github.com/Colinslik/Leetcode/blob/master/001.%20two-sum/two-sum.py) |[:memo:](https://leetcode.com/articles/two-sum/)|Easy|
